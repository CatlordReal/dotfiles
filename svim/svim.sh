...
sketchybar --trigger sketchyvim_mode_changed MODE="$MODE" CMDLINE="$CMDLINE" >/dev/null 2>&1 || true

# This script is executed when either the mode changes,
# or the commandline changes. The variables $MODE and
# $CMDLINE hold the current editor and cmdline info.
