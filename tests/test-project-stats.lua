...
clock = 30 * 1000000000
stats.tick()
assert(stats.summary(second).project_seconds == 16, "stopped timer changed totals")
...
assert(stats.summary(second).project_characters == 1, "saved state was not reloaded")
